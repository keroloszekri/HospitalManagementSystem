...
namespace ADB.PL
{
    public partial class Liver_manage : Form
    {
        MySqlDataAdapter da;
        ...
        void getpateint()
        {
            ...
            DAL.DAL.cmd = new MySqlCommand("get_all_liver", DAL.DAL.con);
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.Rows.Clear();
                dataGridView1.Refresh();
                DAL.DAL.cmd = new MySql.Data.MySqlClient.MySqlCommand("search_liver", DAL.DAL.con);
                DAL.DAL.cmd.CommandType = CommandType.StoredProcedure;
        ...
        {try { 
            ...
            RPT.RPT_liver myrpt = new RPT.RPT_liver();
