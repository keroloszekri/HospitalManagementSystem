...
namespace ADB.PL
{
    public partial class cogulation_profile : Form
    {
        bool t = false;
        String Count;
        public cogulation_profile()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DAL.DAL.cmd = new MySqlCommand("insert into cogulation_profile (cogulation_parameters,cogulation_pt,cogulation_pc,cogulation_inr,cogulation_aptt,pa_national_id) values (@p1,@p2,@p3,@p4,@p5,@p6)", DAL.DAL.con);
                    ...
                    DAL.DAL.cmd.Parameters.AddWithValue("@p5", textBox4.Text);
        ...
        private void cogulation_profile_Load(object sender, EventArgs e)
        {
            try
            {
