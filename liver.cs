...
namespace ADB.PL
{
    public partial class liver : Form
    {
        ...
        private void liver_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DAL.DAL.con.Open();
                if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "" && textBox7.Text != "" && textBox8.Text != "" && textBox9.Text != "" && textBox10.Text != "" && textBox6.Text != "")
                {
                    DAL.DAL.cmd = new MySqlCommand("insert into liver (livercol_parameters,liver_total_bill,liver_direct_bill,liver_AST,liver_ALT,liver_ALP,liver_total_protenis,liver_Alumins,pa_national_id) values (@p1,@p2,@p3,@p4,@p5,@p6,@p7,@p8,@p9)", DAL.DAL.con);
                    ...
                    DAL.DAL.cmd.Parameters.AddWithValue("@p8", textBox10.Text);
                    DAL.DAL.cmd.Parameters.AddWithValue("@p9", textBox6.Text);
                    DAL.DAL.cmd.ExecuteNonQuery();
