...
namespace ADB.PL
{
    public partial class cogulation_profile_mang : Form
    {
        MySqlDataAdapter da;
        DataSet ds = new DataSet();
        public cogulation_profile_mang()
        {
            InitializeComponent();
            getpateint();
        }
        void getpateint()
        {
            ...
            DAL.DAL.cmd = new MySqlCommand("get_cogulation_profile", DAL.DAL.con);
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.Rows.Clear();
                dataGridView1.Refresh();
                DAL.DAL.cmd = new MySql.Data.MySqlClient.MySqlCommand("search_cogulation_profile", DAL.DAL.con);
                DAL.DAL.cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RPT.RPT_cogulation_profile myrpt = new RPT.RPT_cogulation_profile();
